...
def afficher_carte_parcelle(lat: float, lon: float, station_id: str, mesures: dict):
    ...
    - Cercle vert dynamique : opacité diminue quand le zoom augmente.
    """
    if not lat or not lon:
    ...
    # zoom 10 → opacité ~0.55 | zoom 14 → ~0.25 | zoom 18+ → ~0.05
    ...
    zoom_script._template = Template("""
        ...
        (function() {
            ...
            function updateOpacity() {
                ...
                circle.setStyle({ fillOpacity: fillOpacity, opacity: strokeOpacity });
            }
